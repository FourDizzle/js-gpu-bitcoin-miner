...
export default (msg, midstate) => {
  let hash = midstate.slice(), blocks = msg.slice(16), a = 0, b = 0, c = 0,
    d = 0, e = 0, f = 0, g = 0, h = 0, s0 = 0, s1 = 0, maj = 0, t1 = 0, t2 = 0,
    ch = 0, ab = 0, da = 0, cd = 0, bc = 0
  ...
  for (let i = 1; i <= 2; i++) {
    ...
    for (let j = 0; j < 64; j += 4) {
      // figure out the positive of if statement and reset conditional to i===2
      if (i === 3) {
        ab = 704751109;
